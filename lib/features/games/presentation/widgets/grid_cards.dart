...
class GridCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: SemanticLabels.gridGameCards,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      semanticsLabel: '${SemanticLabels.gameName} ${game.name}',
                    ),
                  ),
                  Positioned(
                    right: Insets.small,
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          ...
                          semanticsLabel:
                              '${SemanticLabels.rating} ${game.rating.toStringAsFixed(1)}',
                        ),
                      ],
                    ),
                  ),

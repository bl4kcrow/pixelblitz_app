...
class GamesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: SemanticLabels.verticalGamesList,
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final String formatedReleaseDate = game.released != null
                    ...
                    child: Semantics(
                      ...
                      child: Hero(
                        ...
                        child: AspectRatio(
                          ...
                          child: ClipRRect(
                            borderRadius:
                                BorderRadius.circular(AppRadius.xsmall),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            semanticsLabel:
                                '${SemanticLabels.gameName} ${game.name}',
                          ),
                          Text(
                            game.released != null
